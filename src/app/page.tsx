  ...
  return (
    <div className=" text-white min-h-screen">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            },
            {
              ...
              desc: "Efficient data storage and analysis.",
            },
            {
              url: "/cyber.png",
              title: "CyberSecurity",
              desc: "Robust protection against cyber threats.",
            },
            {
              url: "/consulting.png",
              title: "IT Consulting",
      ...
      <section className="px-8 py-12 bg-gray-800">
        ...
        <p className="mb-8">
          We stand out in the industry with our commitment to agility, Client
          Satisfaction, and a proven history of success.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {[
            {
              ...
              desc: "We adapt quickly to changing needs, ensuring timely delivery and optimal results.",
            },
            {
              url: "/client.png",
              title: "Client-Centric Approach",
              desc: "Your success is our priority, we work closely with you to understand and meet your goals.",
            },
            {
              url: "/record.png",
              title: "Proven Track Record",
              desc: "We have a history of delivering successful IT solutions that drive business growth.",
            },
          ].map((point, i) => (
            <div
              key={i}
            ...
            >
              {/* point Icon */}
              <img src={point.url} alt={point.title} className="w-8 h-8 mb-4" />
